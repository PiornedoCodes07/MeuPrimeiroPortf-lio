...
function navbRolagem() {
    if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
        ...
        document.getElementById("logo").innerText = "PiornedoCodes";
        document.getElementById("logo").style.color = "#ff4d05";
    } else {
...
$('.parallax-window').parallax({ imageSrc: 'imagens/Codigos.jpg' });
